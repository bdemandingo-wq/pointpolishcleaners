...
const services = [
  ...
  },
  {
    ...
    description: "Quick turnovers and pristine guest-ready spaces every time.",
    price: "Custom Quote",
  ...
  },
  {
    ...
    description: "Thorough cleanup after renovations, remodels, or new builds.",
    price: "Custom Quote",
